...
namespace Raidfelden.Services.Ocr.RaidConfigurations
{
	public class BottomMenu1080X1920Configuration : RaidImageConfiguration
	{
		...
		protected override Rectangle GymNamePosition => new Rectangle(210, 100, 870, 100);
		...
		protected override Rectangle RaidTimerPosition => new Rectangle(800, 1060, 170, 80);
